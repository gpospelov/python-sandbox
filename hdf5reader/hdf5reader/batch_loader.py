...
class ParallelBatchLoader:
    ...
    def submit_batch(self):
        ...
        self.queue.append(self.pool.apply_async(self.load_func, args=args))
    ...
    def fill_queue(self):
        try:
            self.mutex.acquire()
            while len(self.queue) < self.max_workers:
                self.submit_batch()
        finally:
            self.mutex.release()
    ...
    def get_batch(self, batch_id):
        success = True
        # print("get_batch({})".format(batch_id))
        ...
        try:
            ...
            # print("get_batch: Waiting to access result")
            res = result.get()
            # print("About to return batch {}".format(res.batch_id))
            return result.get()
        except:
...
if __name__ == '__main__':
    ...
    test_batch_loader(ParallelBatchLoader, "/mnt/space2/pospelov/data/d3hack/ver1/hdf5_v2/datam_*.h5", 20, 32)
    # test_batch_loader(ParallelBatchLoader, "/mnt/space2/pospelov/data/d3hack/ver1/hdf5_v2/datam_*.h5", 20, 32)
